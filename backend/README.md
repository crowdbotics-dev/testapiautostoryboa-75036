...
## Project Structure
    ...
    ├── testapiautostoryboa_75036  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_75036`
...
2. Clone this repo and `cd testapiautostoryboa_75036`
